...
func Generate() error {
	...
	battleServerManagerArchive := NewArchive("battle-server-manager", Targets64ExceptMacOS, overrideWindowsName)
	...
	// Launcher archive
	launcherArchive := NewArchive("launcher", Targets64ExceptMacOS, overrideWindowsName)
